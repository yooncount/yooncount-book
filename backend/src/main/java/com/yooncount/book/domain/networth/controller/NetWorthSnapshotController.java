...
public class NetWorthSnapshotController {
    ...
    public ResponseEntity<ApiResponse<List<NetWorthSnapshotResponse>>> getAll(
        ...
        return ResponseEntity.ok(ApiResponse.ok(snapshotService.getAll(principal.getId())));
    }
    ...
    public ResponseEntity<ApiResponse<NetWorthSnapshotResponse>> capture(
        ...
        return ResponseEntity.status(HttpStatus.CREATED)
                .body(ApiResponse.ok(snapshotService.capture(principal.getId(), request)));
    }
    ...
    public ResponseEntity<ApiResponse<Void>> delete(
        ...
        snapshotService.delete(principal.getId(), id);
