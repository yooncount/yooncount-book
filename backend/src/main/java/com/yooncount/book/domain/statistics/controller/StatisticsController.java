...
public class StatisticsController {
    ...
    public ResponseEntity<ApiResponse<MonthlyStatisticsResponse>> getMonthly(
        ...
        return ResponseEntity.ok(ApiResponse.ok(
                statisticsService.getMonthlyStatistics(principal.getId(), year, month)));
    }
    ...
    public ResponseEntity<ApiResponse<AnnualStatisticsResponse>> getAnnual(
        ...
        return ResponseEntity.ok(ApiResponse.ok(statisticsService.getAnnualStatistics(principal.getId(), y)));
    }
    ...
    public ResponseEntity<ApiResponse<CategoryTrendResponse>> getTrend(
        ...
        return ResponseEntity.ok(ApiResponse.ok(
                statisticsService.getCategoryTrend(principal.getId(), categoryId, months)));
    }
}
